...
class CollectionWrapper(system: ActorSystem, callbackQueue: Queue[CallbackWrapper]) extends Wrapper(system, callbackQueue) with V8SprayJson {
  ...
  def create(receiver: V8Object, token: String, domainId: String, collectionId: String, v8Raw: V8Object, callback: V8Function) = {
    ...
    commandWithCollection(receiver, token, callback) { user => collectionRegion ? CreateCollection(persistenceId(domainId, collectionId), user, jsRaw) }
  }

  def get(receiver: V8Object, token: String, domainId: String, collectionId: String, callback: V8Function) =
    commandWithCollection(receiver, token, callback) { user => collectionRegion ? GetCollection(persistenceId(domainId, collectionId), user, "/") }
  ...
  def replace(receiver: V8Object, token: String, domainId: String, collectionId: String, content: V8Object, callback: V8Function) = {
    ...
    commandWithCollection(receiver, token, callback) { user => collectionRegion ? ReplaceCollection(persistenceId(domainId, collectionId), user, jsContent) }
  }
  ...
  def patch(receiver: V8Object, token: String, domainId: String, collectionId: String, v8Patch: V8Array, callback: V8Function) = {
    ...
    commandWithCollection(receiver, token, callback) { user => collectionRegion ? PatchCollection(persistenceId(domainId, collectionId), user, JsonPatch(jsArray)) }
  }

  def remove(receiver: V8Object, token: String, domainId: String, collectionId: String, callback: V8Function) =
    commandWithSuccess(receiver, token, callback) { user => collectionRegion ? RemoveCollection(persistenceId(domainId, collectionId), user) }

  def getACL(receiver: V8Object, token: String, domainId: String, collectionId: String, callback: V8Function) =
    commandWithACL(receiver, token, callback) { user => collectionRegion ? GetACL(persistenceId(domainId, collectionId), user) }
  ...
  def replaceACL(receiver: V8Object, token: String, domainId: String, collectionId: String, v8ACL: V8Object, callback: V8Function) = {
    ...
    commandWithSuccess(receiver, token, callback) { user => collectionRegion ? ReplaceACL(persistenceId(domainId, collectionId), user, jsACL) }
  }
  ...
  def patchACL(receiver: V8Object, token: String, domainId: String, collectionId: String, v8ACLPatch: V8Array, callback: V8Function) = {
    ...
    commandWithSuccess(receiver, token, callback) { user => collectionRegion ? PatchACL(persistenceId(domainId, collectionId), user, JsonPatch(jsACLPatch)) }
  }
  ...
  def removePermissionSubject(receiver: V8Object, token: String, domainId: String, collectionId: String, operation: String, kind: String, subject: String, callback: V8Function) =
    commandWithSuccess(receiver, token, callback) { user => collectionRegion ? RemovePermissionSubject(persistenceId(domainId, collectionId), user, operation, kind, subject) }
  ...
  def removeEventPermissionSubject(receiver: V8Object, token: String, domainId: String, collectionId: String, operation: String, kind: String, subject: String, callback: V8Function) =
    commandWithSuccess(receiver, token, callback) { user => collectionRegion ? RemoveEventPermissionSubject(persistenceId(domainId, collectionId), user, operation, kind, subject) }
  ...
  def findDocuments(receiver: V8Object, token: String, domainId: String, collectionId: String, query: V8Object, callback: V8Function) = {
    ...
    }.flatMap { user => collectionRegion ? FindDocuments(persistenceId(domainId, collectionId), user, jsQuery) }.recover { case e => e }.foreach {
      case jo: JsObject =>
  ...
  def refresh(receiver: V8Object, token: String, domainId: String, collectionId: String, callback: V8Function) =
    commandWithSuccess(receiver, token, callback) { user => collectionRegion ? Refresh(persistenceId(domainId, collectionId), user) }
