...
define(function () {
  ...
  var 
    peopleList, fakeIdSerial, makeFakeId, mockSio, connect, user;
  ...
  mockSio = (function () {
    var
      on_sio, off_sio, emit_sio, emit_mock_msg,
    ...
    off_sio = function(msg_type, callback){
      callback_map[msg_type] = callback;
    };
    ...
    return { emit : emit_sio, on : on_sio, off : off_sio };
  }());
